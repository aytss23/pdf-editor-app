...
class ViewerController: 
    ...
    def browse_file_push_button_clicked(self):
        selected_file_path = MainModel.start_file_browser(self.viewer_ui, "SELECT A PDF FILE", "PDF Files (*.pdf)")[0] # PDF dosyası seçimi için dosya tarayıcısını başlat.
    ...
    def previous_page_push_button_clicked(self): 
        if self.selected_page != 0: self.selected_page -= 1 # görüntülenecek sayfa numarasını bir azalt.
