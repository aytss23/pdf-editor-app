...
DATABASE_PATH = 'utils\\database\\recent_pdfs.db' # Veritabanı dosya yolu
TABLE_NAME = 'recent_pdfs' # Veritabanı tablosu adı

class RecentFileLogger: # veritabanı yöneticisi sınıfı.
    ...
    # veritabanı tablosundaki tüm verileri sil.
    def delete_recent_pdfs(self): 
        self.database_cursor.execute(f""" DELETE FROM {TABLE_NAME} """)
